...
public class ResourcesCensor {
    ...
    private static final String ACCESS_KEY = "Bku4MNJHn2m-qHPxZ4jDTkkV-tIw6U-u6Ex2mUrW";
    private static final String SECRET_KEY = "eMSL04-fhF-IggfUsa_v87IcX_ehREMA0gVj3iCL";
    ...
    public String ImageCensor() throws QiniuException {
        ...
        uri.put("uri", "https://www-static.qbox.me/_next/static/media/playground-3.639762b51e766cc9e7eb5b6802fe1371.png");

        Map<String, Object> scenes = new HashMap<>();
        //pulp 黄  terror 恐  politician 敏感人物
        String[] types = {"pulp", "terror", "politician", "ads","behavior"};
    ...
    public String VideoCensor() throws QiniuException {
        ...
        Map<String, Object> uri = new HashMap<>();
        uri.put("uri", "https://www-static.qbox.me/_next/static/media/playground-2.0c27a464af54b2c2161c203051e355f1.png");
